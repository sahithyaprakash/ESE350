...
// // Manual calibration:
// static int adc0_0_eeprom = 166;
// static int adc0_180_eeprom = 608;
// static int adc1_0_eeprom = 402;  // zero degree for tilt wiper
// static int adc1_180_eeprom = 812;
// static float resolu_0_eeprom = 0.4072;
// static float resolu_1_eeprom = 0.4390;

// These variables are externs in the header file.
int adc0_0_eeprom = 0;
int adc0_180_eeprom = 0;
int adc1_0_eeprom = 0;  // zero degree for tilt wiper
int adc1_180_eeprom = 0;
float resolu_0_eeprom = 0;
float resolu_1_eeprom = 0;


/* This function is not being used - we are not using eeprom
void get_eeprom() {
...
//    static int previous_adc1;
    ...
    else
    {
        ...
        current_position = (adc0 - adc0_0_eeprom) * resolu_0_eeprom + LOW;
        //if((adc0 <= adc0_0_eeprom) || (adc0 >= adc0_180_eeprom))
        if((adc0 <= adc0_180_eeprom) || (adc0 >= adc0_0_eeprom))
        {
            flag_adc0 = 1;
        }
    }
